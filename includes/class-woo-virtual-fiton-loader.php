 ...
 */
class Woo_Virtual_Fiton_Loader {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $shortcodes    The shortcodes registered with WordPress to be used with the plugin.
	 */
	...
	public function run() {
		...
		foreach ( $this->shortcodes as $hook ) {
			add_shortcode( $hook['hook'], ($hook['component'] ? array( $hook['component'], $hook['callback'] ) : $hook['callback']));
		}
